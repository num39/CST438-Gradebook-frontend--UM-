...
class Gradebook extends React.Component {
    ...
    //when the component first opens, calls fetch grades
     componentDidMount() {
      this.fetchGrades();
    }
 //downloading data and putting into state variable^
    fetchGrades = () => {
       ...
       const columns = [
        ...
        return(
            <div className="App">
              ...
              <div style={{width:'100%'}}>
              //just displays what is in the state variable for debugging
